  ...
  return (
    <div style={{
      ...
      <div className="uv-topbar" style={{
        ...
        {/* Project tabs + inline rename — hidden in the cross-project Accounts view */}
        {isAccounts ? null : editingName ? (
        ...
        <div className="uv-controls-bar" style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 14, flexWrap: "wrap" }}>
            ...
            <div style={{
              ...
              <ToggleBtn active={view === "map"} onClick={() => setView("map")} icon="map">Map</ToggleBtn>
              <ToggleBtn active={view === "list"} onClick={() => setView("list")} icon="list">List</ToggleBtn>
